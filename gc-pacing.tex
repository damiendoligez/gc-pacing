...
work, each block is counted as a number of work units equal to
its size (in words, with header). This is a simple-minded model of the actual
...
\bigskip
$o$ : \verb'overhead' parameter of the runtime system, given by
the user.

$L_n$ : amount of live (marked and reachable) data at the
beginning of cycle $n$

$F_n$ : amount of floating garbage (marked and unreachable) at
the beginning of cycle $n$

$G_n$ : amount of collectible garbage (unmarked and unreachable)
at the beginning of cycle $n$

$S_n$ : amount of data allocated during the Sweep phase of cycle
$n$

$I_n$ : amount of data allocated during the Idle phase of cycle
$n$

$M_n$ : amount of data allocated during the Mark phase of cycle
$n$

$s$ : amount of sweeping work done per word allocated

$m$ : amount of marking work done per word allocated

Note that $s$ and $m$ are exclusive: for each word allocated we do
either $s$ words of sweeping or $m$ words of marking.
...
\sigma = s/m
\end{equation}
This is the ratio of sweeping to marking ``speed''. It
...
sequence $G_n$ will keep growing and memory use is unbounded.
...
\bigskip
$L'_n$ : amount of off-heap live data (linked from live
heap blocks) at the beginning of cycle $n$

$F'_n$ : amount of off-heap floating garbage (linked from
floating garbage heap blocks and not live) at the beginning of
cycle $n$

$G'_n$ : amount of off-heap collectible garbage (linked only from
collectible garbage heap blocks) at the beginning of cycle $n$

$S'_n$ : amount of off-heap data allocated during the Sweep phase
of cycle $n$

$I'_n$ : amount of off-heap data allocated during the Idle phase
of cycle $n$

$M'_n$ : amount of off-heap data allocated during the Mark phase
of cycle $n$

\bigskip
\noindent We introduce two more control parameters for the GC:

\bigskip
$s'$ : amount of GC work done per off-heap word allocated
in the Sweep phase

$m'$ : amount of GC work done per off-heap word allocated
in the Mark phase
...
\bigskip
$L''_n$ : amount of live ephemerons at the beginning of cycle $n$.

$F''_n$ : amount of floating garbage ephemerons at the beginning
of cycle $n$.

$G''_n$ : amount of collectible garbage ephemerons at the
beginning of cycle $n$.

$S''_n$ : amount of ephemerons allocated during the Sweep phase
of cycle $n$.

$I''_n$ : amount of ephemerons allocated during the Idle phase
of cycle $n$.

$M''_n$ : amount of ephemerons allocated during the Mark phase
of cycle $n$.

$W_n$, $W'_n$, $W''_n$ : amounts of heap data, off-heap
data, ephemerons allocated during the Ephe\_sweep phase. (W stands for
``weak'')

$s''$ : amount of GC work done per word of ephemerons allocated
during the Mark phase.

$m''$ : amount of GC work done per word of ephemerons allocated
during the Mark phase.

$w$, $w'$, $w''$ : amounts of work done per word of
